				...
				<div class="content hero">
					<div class="container hero">
						<div class="hero_title">
							<p class="first">I'm Kuryliuk Oleksii<br /><span class="edina_tm_animation_text_word"></span></p>
						</div>
					</div>
				...
				<div class="author_wrap">
					...
					<div class="rightbox">
						<div class="name_holder">
							<h3>I'm Kuryliuk Oleksii</h3>
						</div>
						<div class="definition">
							<p>Hi! My name is Kuryliuk Oleksii. I'm a junior WordPress and front-end developer. Over the past year I have created 2 many page sites on CMS WordPress and several WordPress plugins. During development, I used programming languages such as php and JavaScript. I worked with API and also used technology like ajax. I have a basic knowledge of the OOP paradigm.</p>
							<p>I live in Ukraine, the city of Rivne. This is the western part of Ukraine. I am married. I have daughter, her name is Anna. I love walking with her on the street. I also like to go with her to the forest to breathe fresh air.</p>
						</div>
						<div class="sharebox">
							<ul>
					...
					<div class="edina_tm_list_wrap" data-column="3" data-space="70">
						<ul class="total">
							<li class="wow fadeIn" data-wow-duration="1.2s">
								<div class="inner_list">
									<div class="service_icon">
										<img class="svg" src="<?php echo ANNA_URL . '/assets/' ?>img/svg/camera-diaphragm.svg" alt="" />
									</div>
							...
							<li class="wow fadeIn" data-wow-duration="1.2s" data-wow-delay="0.2s">
								<div class="inner_list">
									<div class="service_icon">
										<img class="svg" src="<?php echo ANNA_URL . '/assets/' ?>img/svg/new-tab.svg" alt="" />
									</div>
									<div class="service_title">
										<h3>Web Design</h3>
									</div>
							...
							<li class="wow fadeIn" data-wow-duration="1.2s" data-wow-delay="0.4s">
								<div class="inner_list">
									<div class="service_icon">
										<img class="svg" src="<?php echo ANNA_URL . '/assets/' ?>img/svg/layers.svg" alt="" />
									</div>
									<div class="service_title">
										<h3>Branding</h3>
									</div>
							...
							<li class="wow fadeIn" data-wow-duration="1.2s" data-wow-delay="0.6s">
								<div class="inner_list">
									<div class="service_icon">
										<img class="svg" src="<?php echo ANNA_URL . '/assets/' ?>img/svg/share.svg" alt="" />
									</div>
									<div class="service_title">
										<h3>Social Media</h3>
									</div>
							...
							<li class="wow fadeIn" data-wow-duration="1.2s" data-wow-delay="0.8s">
								<div class="inner_list">
									<div class="service_icon">
										<img class="svg" src="<?php echo ANNA_URL . '/assets/' ?>img/svg/adobe-illustrator.svg" alt="" />
									</div>
									<div class="service_title">
										<h3>Illustrator</h3>
									</div>
							...
							<li class="wow fadeIn" data-wow-duration="1.2s" data-wow-delay="1s">
								<div class="inner_list">
									<div class="service_icon">
										<img class="svg" src="<?php echo ANNA_URL . '/assets/' ?>img/svg/seo-performance-marketing-graphic.svg" alt="" />
									</div>
									<div class="service_title">
										<h3>Marketing</h3>
									</div>
						...
						<div class="carousel_wrap">
							<ul class="owl-carousel">
								<li class="item">
									<div class="inner">
										<div class="image_holder">
											<img src="<?php echo ANNA_URL . '/assets/' ?>img/clients/1.jpg" alt="" />
										</div>
										<div class="definition">
								...
								<li class="item">
									<div class="inner">
										<div class="image_holder">
											<img src="<?php echo ANNA_URL . '/assets/' ?>img/clients/2.jpg" alt="" />
										</div>
										<div class="definition">
								...
								<li class="item">
									<div class="inner">
										<div class="image_holder">
											<img src="<?php echo ANNA_URL . '/assets/' ?>img/clients/3.jpg" alt="" />
										</div>
										<div class="definition">
				...
				<div class="edina_tm_list_wrap blog_list" data-column="3" data-space="30">
					<ul class="total">
						<li class="wow fadeInUp" data-wow-duration="1.2s">
							<div class="inner_list">
								<div class="image_wrap">
									<img class="small" src="<?php echo ANNA_URL . '/assets/' ?>img/blog/500x350.jpg" alt="" />
									<img class="big" src="<?php echo ANNA_URL . '/assets/' ?>img/blog/1170x450.jpg" alt="" />
									<div class="news_image" data-url="<?php echo ANNA_URL . '/assets/' ?>img/blog/1.jpg"></div>
						...
						<li class="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay="0.2s">
							<div class="inner_list">
								<div class="image_wrap">
									<img class="small" src="<?php echo ANNA_URL . '/assets/' ?>img/blog/500x350.jpg" alt="" />
									<img class="big" src="<?php echo ANNA_URL . '/assets/' ?>img/blog/1170x450.jpg" alt="" />
									<div class="news_image" data-url="<?php echo ANNA_URL . '/assets/' ?>img/blog/2.jpg"></div>
									<a class="link_news" href="index.html"></a>
								</div>
								<div class="definitions_wrap">
									<div class="date_wrap">
						...
						<li class="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay="0.4s">
							<div class="inner_list">
								<div class="image_wrap">
									<img class="small" src="<?php echo ANNA_URL . '/assets/' ?>img/blog/500x350.jpg" alt="" />
									<img class="big" src="<?php echo ANNA_URL . '/assets/' ?>img/blog/1170x450.jpg" alt="" />
									<div class="news_image" data-url="<?php echo ANNA_URL . '/assets/' ?>img/blog/3.jpg"></div>
									<a class="link_news" href="index.html"></a>
								</div>
								<div class="definitions_wrap">
									<div class="date_wrap">
				...
				<div class="content partners">
					<div class="container">
						<div class="edina_tm_partners_wrap">
							<ul class="owl-carousel">
								<li class="item">
									<img src="<?php echo ANNA_URL . '/assets/' ?>img/partners/1.png" alt="" />
								</li>
								<li class="item">
									<img src="<?php echo ANNA_URL . '/assets/' ?>img/partners/3.png" alt="" />
								</li>
								<li class="item">
									<img src="<?php echo ANNA_URL . '/assets/' ?>img/partners/5.png" alt="" />
								</li>
								<li class="item">
									<img src="<?php echo ANNA_URL . '/assets/' ?>img/partners/6.png" alt="" />
								</li>
								<li class="item">
									<img src="<?php echo ANNA_URL . '/assets/' ?>img/partners/7.png" alt="" />
								</li>
								<li class="item">
									<img src="<?php echo ANNA_URL . '/assets/' ?>img/partners/3.png" alt="" />
								</li>
